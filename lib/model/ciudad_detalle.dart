...
//
//     final ciudadDetalle = ciudadDetalleFromJson(jsonString);

import 'dart:convert';

CiudadDetalle ciudadDetalleFromJson(String str) => CiudadDetalle.fromJson(json.decode(str));

String ciudadDetalleToJson(CiudadDetalle data) => json.encode(data.toJson());
...
class CiudadDetalle {
  ...
  factory CiudadDetalle.fromJson(Map<String, dynamic> json) => CiudadDetalle(
